...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:TextBox ID="RawText" runat="server" Height="300px" TextMode="MultiLine" Width="100%" ></asp:TextBox>
        ...
        <div class="col-md-4">
            ...
            <asp:TextBox ID="EncryptedText" runat="server" Height="300px" TextMode="MultiLine" Width="100%" ></asp:TextBox>
